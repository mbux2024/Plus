package com.homeflix.tv.ui.util
...
/**
 * Tracks a held D-pad SELECT / ENTER key so we can distinguish a normal click
 * (short press) from a long press. Mirrors NuvioTV's LongPressKeyTracker so the
 * remote "feel" matches: hold OK/Center on a poster to open its options menu.
 */
@Composable
...
/** True for the keys that should act as SELECT (D-pad center / enter). */
